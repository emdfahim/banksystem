...
public class BankSystem extends JFrame implements ActionListener, ItemListener {
	...
	String imageFolder ="src/View/Images/";  
	...
	public BankSystem () {
		...
		setIconImage (getToolkit().getImage (imageFolder+"Bank.gif"));
		setSize (700, 550);
		setJMenuBar (bar);
		...
		addNew = new JMenuItem ("Open New Account", new ImageIcon (imageFolder+"Open.gif"));
		addNew.setAccelerator (KeyStroke.getKeyStroke(KeyEvent.VK_N, Event.CTRL_MASK));
		addNew.setMnemonic ((int)'N');
		addNew.addActionListener (this);
		printRec = new JMenuItem ("Print Customer Balance", new ImageIcon (imageFolder+"New.gif"));
		...
		end = new JMenuItem ("Quit BankSystem ?", new ImageIcon (imageFolder+"export.gif"));
		...
		delRec = new JMenuItem ("Delete Customer", new ImageIcon (imageFolder+"Delete.gif"));
		...
		search = new JMenuItem ("Search By No.", new ImageIcon (imageFolder+"find.gif"));
		...
		allCustomer = new JMenuItem ("View All Customer", new ImageIcon (imageFolder+"refresh.gif"));
		...
		content = new JMenuItem ("Help Contents", new ImageIcon (imageFolder+"paste.gif"));
		...
		about = new JMenuItem ("About BankSystem", new ImageIcon (imageFolder+"Save.gif"));
		...
		open = new JMenuItem ("Open New Account", new ImageIcon (imageFolder+"Open.gif"));
		open.addActionListener (this);
		report = new JMenuItem ("Print BankSystem Report", new ImageIcon (imageFolder+"New.gif"));
		report.addActionListener (this);
		dep = new JMenuItem ("Deposit Money");
		dep.addActionListener (this);
		with = new JMenuItem ("Withdraw Money");
		with.addActionListener (this);
		del = new JMenuItem ("Delete Customer", new ImageIcon (imageFolder+"Delete.gif"));
		del.addActionListener (this);
		find = new JMenuItem ("Search Customer", new ImageIcon (imageFolder+"find.gif"));
		find.addActionListener (this);
		all = new JMenuItem ("View All Customer", new ImageIcon (imageFolder+"refresh.gif"));
		...
		btnNew = new JButton (new ImageIcon (imageFolder+"NotePad.gif"));
		btnNew.setToolTipText ("Create New Account");
		btnNew.addActionListener (this);
		btnDep = new JButton (new ImageIcon (imageFolder+"ImationDisk.gif"));
		btnDep.setToolTipText ("Deposit Money");
		btnDep.addActionListener (this);
		btnWith = new JButton (new ImageIcon (imageFolder+"SuperDisk.gif"));
		btnWith.setToolTipText ("Withdraw Money");
		btnWith.addActionListener (this);
		btnRec = new JButton (new ImageIcon (imageFolder+"Paproll.gif"));
		btnRec.setToolTipText ("Print Customer Balance");
		btnRec.addActionListener (this);
		btnDel = new JButton (new ImageIcon (imageFolder+"Toaster.gif"));
		btnDel.setToolTipText ("Delete Customer");
		btnDel.addActionListener (this);
		btnSrch = new JButton (new ImageIcon (imageFolder+"Search.gif"));
		btnSrch.setToolTipText ("Search Customer");
		btnSrch.addActionListener (this);
		btnHelp = new JButton (new ImageIcon (imageFolder+"Help.gif"));
		btnHelp.setToolTipText ("Help on Bank System");
		btnHelp.addActionListener (this);
		btnKey = new JButton (new ImageIcon (imageFolder+"Keys.gif"));
	...
	private void quitApp () {
		...
		try {
			...
			if (reply == JOptionPane.YES_OPTION) {
				...
				System.out.println ("Thanks for Using BankSystem\nAuthor - Muhammad Wasif Javed\nConverted to MVC Pattern by Mohammad Fahim, ID: 18101487, for CSE470 Project");
